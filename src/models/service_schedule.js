...
class ServiceSchedule {
  ...
  static isTypeRoutine = (type) => {
    return type === "routine";
  };

  static isTypeSingle = (type) => {
    return type === "single";
  };
  ...
  static createServiceSchedule(serviceSchedule) {
    ...
    const materials =
      serviceSchedule.materials === null ? [] : serviceSchedule.materials;
    const employees =
      serviceSchedule.employees === null ? [] : serviceSchedule.employees;
    ...
    return new Promise((resolve, reject) => {
      ...
      } else if(this.isTypeRoutine(serviceSchedule.type)){
        // TODO: add routine query
      }
    });
  }
