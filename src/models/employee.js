...
class Employee extends User {
  ...
  static createEmployeeUser (employee) {
    return new Promise((resolve, reject) => {
      connection.query("CALL sp_insert_employee(?,?,?,?,?,?,?,?,?,?,?,?,?)", 
      [
        employee.name,
        employee.last_name,
  ...
  static getAllEmployee() {
    return new Promise((resolve, reject) => {
      connection.query("CALL sp_get_employee_list()",
      (error, result) => {
  ...
  static getSingleEmployee(employee_id){
    return new Promise((resolve, reject) => {
      ...
      connection.query("CALL sp_get_employee_by_id(?, @p_name, @p_last_name, @p_cell_number, @p_role, @p_birth_date, @p_active, @p_image_name, @p_job_title, @p_department, @p_driver_license, @p_start_date,  @p_wage_per_hour, @p_email)", 
      employee_id,
      (error, result) => {
        error ? reject(error) : connection.query("SELECT @p_name, @p_last_name, @p_cell_number, @p_role, @p_birth_date, @p_active, @p_image_name, @p_job_title, @p_department, @p_driver_license, @p_start_date, @p_wage_per_hour, @p_email;",
        (error, result) =>{
  ...
  static employeeUpdated(employee){
    return new Promise((resolve, reject) => {
      connection.query("CALL sp_update_employee_details(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", 
      [
  ...
  static deleteEmployee(employeeId){
    return new Promise((resolve, reject) => {
      connection.query('CALL sp_delete_employee_and_user(?)', employeeId,
      (error, result) => {
        return error ? reject(error) : resolve(result);
      });
    })
